...
public class MainActivity extends AppCompatActivity {
    ...
    private ScanCallback leScanCallback = new ScanCallback() {
        ...
        public void onScanResult(int callbackType, ScanResult result) {
            peripheralTextView.append("Index: " + deviceIndex + ", Device Name:  ESP32 Pro rssi: " + result.getRssi() + "\n");
    ...
    public void connectToDeviceSelected() {
        peripheralTextView.append("\nTrying to connect to device at index: " + deviceIndexInput.getText() + "\nDevice Connected");
        Random rand = new Random();
        peripheralTextView.append("Received UUID: 0x" + rand.nextInt(0x10)+0x1000*1000);
